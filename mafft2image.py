...
from functions import read_mafft
...
def main(argv):
    ...
    try:
        ...
        print('mafft2image.py -i <inputfile> -o <outputfolder>')
        sys.exit(2)
    ...
    for record in alignment:
        repetitions_id.append(record[0])
        # print(record[0])
    ...
    print('Output: ' + file + '_conservation.png')
    plt.close()
    ...
    print('Output: ' + file + '_alignment.png')
    plt.close()
